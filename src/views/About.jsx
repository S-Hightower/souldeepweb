...
function About() {
    return(
        ...
        <img src={skittles} width="400" height="400" alt="black cat looking dapper with bowtie" />
        <br />
        </div>
        <div className={styles.photo_group3}>
        <img src={apollo} width="400" height="500" alt="cat looking dapper with bowtie"/>
        ...
        <img src={outlook} width="500" height="500" alt="scenic outlook towards the ocean and horizon" />
        <br />
        </div>
        ...
        <br />
            <h4 className="text-white">Here is a recent video interview for Awoke TV where I go over all the many services offered:<a href="https://vimeo.com/475300685/c6dc744052">Watch Here</a></h4>
        </div>
        </div>
        <Footer />
        </>
